        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ymUserValidEmailCheck", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("ymUserValidPhoneCheck", "Phone Like '01%' and Phone Not Like '%[^0:9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlanValidDurationCheck", "DurationDays Between 1 and 365 ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ymUserValidEmailCheck1", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("ymUserValidPhoneCheck1", "Phone Like '01%' and Phone Not Like '%[^0:9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionValidStartEndDateCheck", "EndDate > StartDate");
                    table.ForeignKey(
