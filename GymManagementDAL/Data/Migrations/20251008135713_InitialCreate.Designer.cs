...
{
    [DbContext(typeof(GymManagementDAL.Data.Contexts.GymDbContext))]
    [Migration("20251008135713_InitialCreate")]
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plan", t =>
                        {
                            t.HasCheckConstraint("PlanValidDurationCheck", "DurationDays Between 1 and 365 ");
                        });
                });
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("SessionValidStartEndDateCheck", "EndDate > StartDate");
                        });
                });
